    ...
    <div class="page-login">
        ...
        <div class="login-panel">
            ...
            <div class="form">
                ...
                <el-input :class="{error: error && !password}" v-model="password" type="password" placeholder="密码" prefix-icon="el-icon-unlock"></el-input>
                <div class="foot"><a href="https://passport.meituan.com/useraccount/retrievepassword?risk_partner=0&service=www&continue=https%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttps%253A%252F%252Fgz.meituan.com%252F">忘记密码？</a></div>
